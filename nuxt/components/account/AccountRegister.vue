<template>
  <div>
    <div v-if="accountIsCreated" class="my-8 flex flex-wrap md:items-center">
      <div
    ...
    <div v-if="!accountIsCreated" class="-m-8 flex flex-wrap md:items-center">
                ...
                <div class="form-control w-auto p-3">
                  <div class="flex items-center">
                    ...
                    <label
                      ...
                      ><a class="text-secondary hover:text-primary" href="#">
