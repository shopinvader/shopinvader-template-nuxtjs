...
.aside-drawer {
  ...
  &__side {
    @apply absolute flex h-screen w-11/12 max-w-sm flex-col overflow-y-auto bg-white shadow-xl;
    ...
    .side {
      ...
      &__content {
        @apply flex grow flex-col items-start justify-start overflow-auto p-6;
      }
