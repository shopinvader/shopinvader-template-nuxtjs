...
.search-autocomplete {
  ...
  &--focused {
    .search-autocomplete__form {
      @apply fixed -left-1/2 -right-1/2 top-0 z-40 mx-auto overflow-hidden bg-white lg:container max-lg:w-screen max-lg:overflow-auto lg:top-5  lg:rounded-2xl lg:p-2;
      .form {
