...
.search {
  @apply grid min-h-screen grid-cols-1 gap-2 px-2 py-4 lg:grid-cols-4 xl:grid-cols-5 auto-rows-min;
  &__filters {
  ...
  &__results {
    ...
    .results {
      &__noresults {
        @apply flex flex-col items-center justify-center py-32 text-xl col-span-full;
      }
      &__history {
        @apply p-4;
      }
  ...
  &__stats {
    @apply flex w-full grow flex-wrap items-center justify-between pb-4;
    .search__pagination {
      @apply py-0;
    }
  }
